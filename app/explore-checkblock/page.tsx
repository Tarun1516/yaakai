...
export default function ExploreCheckblock() {
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="flex items-center mb-8">
        <Image
          ...
          className="mr-4"
        />
        <h1 className="text-4xl font-bold">CheckBlock - VPN Detector and Blocker</h1>
      </div>
      ...
      {[
        ...
        <motion.section
          key={index}
          className="mb-12 bg-white/30 backdrop-blur-md p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-2">Windows Requirements</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-2">Linux Requirements</h3>
            <ul className="list-disc list-inside">
      ...
      >
        <Button
          ...
          className="bg-[#f59f0a] text-black border-2 border-[#f59f0a] hover:bg-[#f59f0a]/90 rounded-full px-8 py-3 text-lg"
        >
          Add to Cart
        </Button>
      </motion.div>
